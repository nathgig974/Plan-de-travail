...
\begin{pspicture}(0.5,0)(18,12)            
   ...
   \rput[l](0,8){%bulle NNO : connaissances et compétences
      \pspolygon[fillstyle=solid,fillcolor=teal,linecolor=teal](6,0)(8,-1.5)(6.4,0)
      \bullecours
         {teal}
   ...
   \rput[l](14,4){%bulle ENE : Aide vidéo
      \pspolygon[fillstyle=solid,fillcolor=teal,linecolor=teal](0,3.2)(-2.5,2)(0,3.5)
      \bulleQR
         {teal}
         {Aide en vidéo}
      ...
      \rput[l](0,0){%bulle SO : Compétence 1
         \pspolygon[fillstyle=solid,fillcolor=purple,linecolor=purple](5,2)(7.2,4.5)(5,2.35)
         \bulle
            {purple}
            {Compétence 1}
      ...
      \rput[l](6.5,0){%bulle S : compétence 2
         \pspolygon[fillstyle=solid,fillcolor=purple,linecolor=purple](2.35,3)(2.5,4.5)(2.65,3)
         \bulle
            {purple}
            {Compétence 2}
      ...
      \rput[l](13,0){%bulle SE : compétence 3
          \pspolygon[fillstyle=solid,fillcolor=purple,linecolor=purple](0,2)(-2.3,4.5)(0,2.35)
          \bulle
            {purple}
            {Compétence 3}
...
\begin{pspicture}(0.5,0)(18,13)            
   ...
   \rput[l](14,4){%bulle ENE : Aide vidéo
      ...
      \rput[l](0,0){%bulle SSO : Compétence 1
         \pspolygon[fillstyle=solid,fillcolor=purple,linecolor=purple](5,3)(8,4.5)(5.5,3)
         \bullelongue
            {purple}
            {Compétences 1 et 2}
            {Activité d'approche \hfill $\star$ \hfill $\square$ \par
      ...
      \rput[l](10,0){%bulle S : compétence 2
         \pspolygon[fillstyle=solid,fillcolor=purple,linecolor=purple](3,3)(0.5,4.5)(3.5,3)
         \bullelongue
            {purple}
            {Compétence 3}
            {Exercice 4 \hfill $\star$ \hfill $\square$ \par
